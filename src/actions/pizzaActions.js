...
export const getPizzaById=(pizzaid)=>async dispatch=>{
    ...
    try {
        const response = await axios.post(`${config.api}/api/pizzas/getpizzabyid` , {pizzaid})
        console.log(response);
...
export const addPizza=(pizza)=>async dispatch=>{
    ...
    try {
        const response= await axios.post(`${config.api}/api/pizzas/addpizza` , {pizza})
        console.log(response);
...
export const editPizza=(editedpizza)=>async dispatch=>{
    ...
    try {
        const response= await axios.post(`${config.api}/api/pizzas/editpizza` , {editedpizza})
        console.log(response);
...
try {
    const response =await axios.post(`${config.api}/api/pizzas/deletepizza` , {pizzaid})
